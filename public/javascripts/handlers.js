...
function fileQueued(file) {
	try {
		document.getElementById("photo_files").innerHTML += "<div id =\"file_"+file.id+"\">" + file.name  + " <a href = 'javascript:void(0);' onclick ='cancelfile(\""+file.id+"\")'><img src=\"/images/cross.png\" align = \"absmiddle\"></a></div>"

//		document.getElementById("akhil").innerHTML += file.name
//		document.getElementById("akhil").innerHTML += " <a href = 'javascript:void(0);' onclick ='cancelfile(\""+file.id+"\")'>X</a>"
//		document.getElementById("akhil").innerHTML += ', '  
//		document.getElementById("akhil").innerHTML += "</div>"
...
function addImage(id) {
  $('vehicle_photos').value = $('vehicle_photos').value +  id + ',' 
}
